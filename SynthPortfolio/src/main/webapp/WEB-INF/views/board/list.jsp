							...
							<div class="col-6">
								<form action="/board/list" method="get" >
									<select name="type">
										...
										<option value="A" ${pageMaker.cri.type == 'A'? 'selected': ''}>내용</option>
										<option value="W" ${pageMaker.cri.type == 'W'? 'selected': ''}>작성자</option>
										<option value="TC" ${pageMaker.cri.type == 'TC'? 'selected': ''}>제목 or 내용</option>
										<option value="TA" ${pageMaker.cri.type == 'TA'? 'selected': ''}>제목 or 작성자</option>
										<option value="TAC" ${pageMaker.cri.type == 'TWC'? 'selected': ''}>제목 or 작성자 or 내용</option>
									</select>
