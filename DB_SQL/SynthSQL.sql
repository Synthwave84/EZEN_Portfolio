...
CREATE TABLE ITEM_TBL (
        ...
        GRADE               VARCHAR2(5)             DEFAULT 'N/A',  -- NULL값이 남발되어 DEFAULT ON NULL을 적용코자 하였으나 11G 
        GEN                 VARCHAR2(20)            DEFAULT 'N/A',  -- 버젼에선 적용할 수 없었음. 
        RAM_TYPE            VARCHAR2(10)            DEFAULT 'N/A',
        M2                  VARCHAR2(5)             DEFAULT 'N/A',
        F_FACTOR            VARCHAR2(10)            DEFAULT 'N/A',
...
(
    ...
    CONSTRAINT  PK_COMP_OPTION            PRIMARY KEY(COMP_NAME)

);

INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('INTEL_LGA1151v2','인텔 8~9세대 LGA 1151 v2','GEN');
    
INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('INTEL_LGA1200','인텔 10~11세대 LGA 1200','GEN');

INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('INTEL_LGA1700','인텔 12~14세대 LGA 1700','GEN');
    
INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('AMD_AM4','라이젠 1~5천번대 AM4', 'GEN');
    
INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('AMD_AM5','라이젠 7천번대 AM5', 'GEN');
    
INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('1','1등급(하급)', 'GRADE');   
    
INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('2','2등급(중급)', 'GRADE');  

INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('3','2등급(상급)', 'GRADE');  

INSERT INTO COMP_OPTION ( COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('4','2등급(최상급)', 'GRADE');  
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('DDR4','DDR4','RAM_TYPE');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('DDR5','DDR5','RAM_TYPE');

INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('N_DDR4','노트북용 DDR4','RAM_TYPE');

INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('N_DDR5','노트북용 DDR5','RAM_TYPE');

INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('00','M.2슬롯 없음','M2');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('01','M.2 슬롯 1개','M2');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('02','M.2 슬롯 2개','M2');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('03','M.2 슬롯 3개','M2');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('04','M.2 슬롯 4개','M2');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('ITX','ITX 사이즈','F_FACTOR');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('M-ATX','M-ATX 사이즈','F_FACTOR');
    
INSERT INTO COMP_OPTION (COMP_NAME, COMP_VALUE, COMP_TYPE)
    VALUES ('ATX','ATX 사이즈','F_FACTOR');
...
SELECT *
FROM COMP_OPTION
WHERE COMP_TYPE IN ('M2', 'GEN');

CREATE TABLE MANUFACTURE_OPTION 
(
    MANUFACTURE_NAME        VARCHAR2(30)        NOT NULL,
    CG_CODE                 NUMBER
    
    CONSTRAINT  PK_MANUF_OPTION     PRIMARY KEY(MANUFACTURE_NAME),
    FOREIGN KEY(CG_CODE)            REFERENCES CG_CODE_TBL(CG_CODE)
);
DROP TABLE CPU_TBL;
...
DROP SEQUENCE SEQ_CPU_TBL; 
CREATE SEQUENCE SEQ_CPU_TBL; 
